...
class StartPage(tk.Frame):
	def __init__(self,parent,controller):
		...
		label1=tk.Label(self,text="ATTENDANCE MANAGEMENT SYSTEM",font=("Times",26,"underline"),padx=10,pady=10)
...
class NewRecord(tk.Frame):
	def __init__(self,parent,controller):
		tk.Frame.__init__(self,parent)
		label1=tk.Label(self,text="New Record",font=("Times",24,"underline"),pady=10)
		label2=tk.Label(self,text="NOTE : If you want a new record, previous record will be deleted.\nDo you want to continue?",font=("Times",14))
...
class ManageAttendance(tk.Frame):
	def __init__(self,parent,controller):
		...
		label1=tk.Label(self,text="Manage Attendance",font=("Times",24,"underline"),pady=10)
		label1.pack()
...
class DeleteRecord(tk.Frame):
	def __init__(self,parent,controller):
		tk.Frame.__init__(self,parent)
		label1=tk.Label(self,text="Delete Record",font=("Times",24,"underline"),pady=10)
		label2=tk.Label(self,text="This action will delete the record.\n Do you want to continue?",font=("Times",12))
...
class EditRecord(tk.Frame):
	def __init__(self,parent,controller):
		tk.Frame.__init__(self,parent)
		label1=tk.Label(self,text="Edit Record",font=("Times",24,"underline"),pady=10)
		bt1=tk.Button(self,text="Back to home",bg="red",font=("Times",16),height=2,width=17,command=lambda:controller.show_frame(StartPage))
		label1.pack()
	...
	def update(self,i,p,b):
		...
		try:
			...
			messagebox.showinfo("Alert!", " The entered subjected is not saved in the record.\n"+"                        "+" Please recheck.")
	...
	def showid(self,controller):
		try:
			...
			messagebox.showinfo("Alert!", "There is no record of the subject")


class AddSubjects(tk.Frame):
	def __init__(self,parent,controller):
		tk.Frame.__init__(self,parent)
		label1=tk.Label(self,text="Enter subject names seperated by commas(,)",font=("Times",16))
	...
	def addsub(self,a,controller):
		...
		if len(a)==1 and a[0]=="" :
			...
			conn.commit()
			conn.close()
			messagebox.showinfo("Success!", "Subjects are added in the record")
			controller.show_frame(StartPage)
...
class TodayData(tk.Frame):
	def __init__(self,parent,controller):
		tk.Frame.__init__(self,parent)
		label1=tk.Label(self,text="Enter data of today",font=("Times",24,"underline"))
		label1.pack()
		...
		lb3=tk.Label(self,text="Number of times attended:",font=("Times",15))
		txt2=tk.Entry(self)
		lb4=tk.Label(self,text="Number of times absent:",font=("Times",15))
		txt3=tk.Entry(self)
		lb3.pack(pady=5)
		txt2.pack(pady=5)
		lb4.pack(pady=5)
...
def main():
	...
	app.title("Attendance Management CBIT")
	app.mainloop()
